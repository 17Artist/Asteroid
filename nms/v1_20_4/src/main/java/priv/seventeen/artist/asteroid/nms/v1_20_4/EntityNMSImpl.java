...
public class EntityNMSImpl implements IEntityNMS {
    ...
    static {
        try {
            ...
            SIZE_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "bh", EntityDimensions.class);
            HEIGHT_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "bi", float.class);
        } catch (Exception e) {
