...
public class EntityNMSImpl implements IEntityNMS {
    ...
    static {
        try {
            ...
            SIZE_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "bb", EntityDimensions.class);
            HEIGHT_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "bc", float.class);
        } catch (Exception e) {
