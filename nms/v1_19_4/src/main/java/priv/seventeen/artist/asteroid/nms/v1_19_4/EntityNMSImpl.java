...
public class EntityNMSImpl implements IEntityNMS {
    ...
    static {
        try {
            ...
            SIZE_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "be", EntityDimensions.class);
            HEIGHT_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "bf", float.class);
        } catch (Exception e) {
