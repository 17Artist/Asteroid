...
public class EntityNMSImpl implements IEntityNMS {
    ...
    static {
        try {
            ...
            SIZE_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "dimensions", EntityDimensions.class);
            HEIGHT_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "eyeHeight", float.class);
        } catch (Exception e) {
