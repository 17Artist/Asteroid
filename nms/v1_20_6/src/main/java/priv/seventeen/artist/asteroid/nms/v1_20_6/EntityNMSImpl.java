...
public class EntityNMSImpl implements IEntityNMS {
    ...
    static {
        try {
            ...
            SIZE_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "bf", EntityDimensions.class);
            HEIGHT_HANDLE = lookup.findVarHandle(net.minecraft.world.entity.Entity.class, "bg", float.class);
        } catch (Exception e) {
