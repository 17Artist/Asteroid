...
public class SeatEntityImpl extends ArmorStand {
    ...
    private static EntityType<? extends ArmorStand> armorStandType() {
        return (EntityType<? extends ArmorStand>) BuiltInRegistries.ENTITY_TYPE.getValue(Identifier.withDefaultNamespace("armor_stand"));
    }

    public SeatEntityImpl(Level level, CustomEntityImpl parent, Offset offset) {
        super(armorStandType(), level);
        this.parent = parent;
        this.offset = offset;
